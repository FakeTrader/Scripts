/**
 * TickTick/滴答清单 （5.4及之前版本）
 *
 * [rewrite_local]
 * ^https:\/\/(ticktick|dida365)\.com\/api\/v2\/user\/status url script-response-body https://raw.githubusercontent.com/eegod/Scripts/master/_scripts/TickTick.js
 *
 * [mitm]
